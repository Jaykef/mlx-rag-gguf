...
## Update
- Added support for [phi-3-mini-4k-instruct.gguf](https://huggingface.co/Jaward/phi-3-mini-4k-instruct.Q4_0.gguf) and other Q_1, Q_2 & Q_4 models, download and save model in models/phi-3-mini-instruct folder
